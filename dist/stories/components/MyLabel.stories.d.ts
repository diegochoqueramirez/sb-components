...
export declare const CustomLabelColor: ComponentStory<({ allCaps, color, label, size, fontColor, backgroundColor, }: import("../../components/MyLabel").MyLabelProps) => JSX.Element>;
export declare const CustomLabelBackgroundColor: ComponentStory<({ allCaps, color, label, size, fontColor, backgroundColor, }: import("../../components/MyLabel").MyLabelProps) => JSX.Element>;
